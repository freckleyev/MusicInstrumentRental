...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var Collection<int, RentalRequests>
     */
    #[ORM\OneToMany(targetEntity: RentalRequests::class, mappedBy: 'user')]
    ...
    /**
     * @return Collection<int, RentalRequests>
     */
    ...
    public function addInstrument(RentalRequests $instrument): static
    {
    ...
    public function removeInstrument(RentalRequests $instrument): static
    {
